...
%%% NAME other design
\node[color=white, fill=strongblue, draw=none, line width=2pt, font=\huge, scale=1.8, rounded corners, anchor=south west] (name) at ($(split.center) + (\divisionlinepad, 4*\sectionpad)$) {\textcolor{white}{~~~~John R. Mahoney~~~~}};

%%% Profile
\matrix[sec_body_mat, anchor=north, line width=2pt, draw=none,
column 1/.style={sec_text, font=\Large}] (profile) at ($(name.south) + (0, -\sectionpad)$){
\emph{
%I am a lifelong learner who cares deeply about our world and the beings in it.
I love to create, connect, and share.
